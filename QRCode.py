...
label1 = Label(Frame1,text="Enter the text/URL: ",bg="Purple",fg='azure',font=('Courier',13,'bold'))
...
label2 = Label(Frame2,text="Enter the location to save the QR Code: ",bg="Purple",fg='azure',font=('Courier',13,'bold'))
...
label3 = Label(Frame3,text="Enter the name of the QR Code: ",bg="Purple",fg='azure',font=('Courier',13,'bold'))
...
label4 = Label(Frame4,text="Enter the size from 1 to 40 with 1 being 21x21: ",bg="Purple",fg='azure',font=('Courier',13,'bold'))
